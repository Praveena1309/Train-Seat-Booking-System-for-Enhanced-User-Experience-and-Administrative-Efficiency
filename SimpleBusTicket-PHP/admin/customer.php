...
<body>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addCustomerForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" onsubmit="return validateAadhaar() && validatephone()">
                            <div class="mb-3">
                                <label for="cfirstname" class="form-label">Name</label>
                                <input type="text" class="form-control" id="cfirstname" name="cfirstname">
                            </div>
                            <div class="mb-3">
                                <label for="clastname" class="form-label">Adhar Number</label>
                                <input type="tel" class="form-control" id="clastname" name="clastname">
                            </div>
                            <div class="mb-3">
    ...
    function validateAadhaar() {
        var aadhaar = document.getElementById("clastname").value;
        var regex = /^\d{12}$/; // Regular expression to match 12 digits
    ...
    function validatephone () {
        var aadhaar = document.getElementById("cphone").value;
        var regex = /^\d{10}$/; // Regular expression to match 12 digits
