...
<body>
            ...
            <hr>
                <p class="mb-0">
                    <ul class="pnr-details">
                        ...
                        <li>
                            <strong>Customer Name(Adhar Number) : </strong>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">INDIAN RAILWAYS</a>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome to Indian Railways. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        <section id="info-num">
            <figure>
                <img src="assets/img/stops.png" alt="Bus Route Icon" width="100px" height="100px">
                <figcaption>
                    <span class="num counter" data-target="<?php echo count($routeData); ?>">999</span>
                    <span class="icon-name">Stops</span>
                </figcaption>
            </figure>
            <figure>
            <img src="assets/img/track.jpg" alt="Bus Icon" width="100px" height="100px" style="
    border-radius: 44%;
">
                <figcaption>
                    <span class="num counter" data-target="<?php echo count($busData); ?>">999</span>
                    <span class="icon-name">Stations</span>
                </figcaption>
            </figure>
            <figure>
        ...
        <section id="about">
            <div>
                ...
                <p>
                Indian Railways, often referred to as the Lifeline of the Nation, is the national railway system of India. With a history dating back to 1853 when the first passenger train ran from Mumbai to Thane, Indian Railways has become one of the largest railway networks in the world. Operating under the Ministry of Railways, it plays a vital role in connecting people, facilitating the movement of goods, and promoting economic growth across the country.

Covering over 67,000 kilometers of track, Indian Railways operates on a broad gauge network, making it the fourth-largest railway network globally. It is divided into zones and divisions, with 18 zones responsible for managing the operations and maintenance of trains within their respective areas. This extensive network ensures that even remote villages and towns are connected, enabling millions of people to travel to various destinations every day.
        ...
        <section id="contact">
            <div id="contact-form">
                ...
                <div class="row">
                    <div class="col-6"> 
                       <img src="assets/img/13fb9a92634417.5e4fea4d41ed6-removebg-preview.png"  style="margin-left:-100px;" > 
                    </div>


                    <div class="col-6" style="width:100px"> 
                        <h5 style="width:157px; margin-top:68px;   margin-left: -26px;">HELPLINE LINE</h5>
                        <h5 style="margin-left: -26px;"><i class="bi bi-telephone"></i>139</h5>
